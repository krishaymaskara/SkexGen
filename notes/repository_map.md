# SkexGen repository map

This document describes the pipeline implemented by this repository, as inspected at commit `c38f30e`. It distinguishes behavior present in the code from terminology inferred from the README/paper naming.
...
| File | Role |
|---|---|
| `notes/research_question.md` | Existing project-local note, empty at inspection time. |
| `notes/graph_schema.md` | Existing project-local note, empty at inspection time. |
| `notes/week1.md` | Existing project-local note, empty at inspection time. |
| `notes/repository_map.md` | This repository map. |
