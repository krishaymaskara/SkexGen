# Upstream SkexGen README

This is the original inherited SkexGen README, preserved as historical
reference. Its commands describe the upstream ICML 2022 system, not the
current structured-CAD research extension. Use the repository-root README and
the [current documentation index](../README.md) for this project's workflow.
