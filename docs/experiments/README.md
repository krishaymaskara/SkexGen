...
| GE1 Stage 6 structure-only producer | `5f4542f86756dae44435af27a6e072db6f27a8ef` | `3354961` | Local stdout/stderr and terminal/sacct transcript; retained wrappers authenticated by job-3355134 artifact | Six arm/seed train runs completed through epoch 200; scientific train gate failed before development, checkpoint-bundle creation, or producer-artifact finalization | `verified-local` | [Record](ge1_stage6_structure_only_producer_3354961.md) |
| GE1 Stage 6 train-gate postmortem | `ddf9617fb124fbc18f38302943f0c982019bfee9` | `3355134` | Local six-file artifact, stdout, stderr, and sacct; manifest and full committed verifier pass | Authorized narrow train and exact six retained wrappers only; train-only inference, zero training or checkpoint mutation, development remained closed | `verified-local` | [Record](ge1_stage6_train_gate_postmortem_3355134.md) |
...
| GE1 grid-softmax magnitude authoritative CPU validation | `12521f64c73bf5f818156fe62722e64a0537d59c` | `3355745` | Local stdout, stderr, sacct, and SHA-256 manifest, all locally rehashed and matching | Corpus-free engineering validation of the prospective grid-softmax magnitude identity; 63/63 focused, 709 discovered with exactly the six allowlisted CUDA skips, all sibling suites at declared counts; no manifest, payload, training, checkpoint write, CAD kernel, Stage 6, or C8 | `verified-local` | [Record](ge1_grid_softmax_magnitude_validation_3355745.md) |
| GE1 memory-to-count prerequisite probe | `25d9510d2b7b502b69b7387f1f0937509d3ef9ba` | `3355776` | Verified five-file artifact, stdout/stderr SHA-256, and scheduler evidence | Read-only narrow-train linear probe over six retained epoch-200 checkpoints; valid artifact but prerequisite false because typed-graph seed 2028 missed the prospective 0.90 floor for memory and prequant; no retrain, development, protected access, CAD kernel, or Stage 6 | `verified-local` | [Record](ge1_memory_count_probe_3355776.md) |
| GE1 autonomous-stop authoritative CPU validation | `288327e42b8575f774b9df668df288d3fa71ae33` | `3355790` | Locally rehashed stdout/stderr plus scheduler evidence | Corpus-free exact-commit engineering validation; 19/19 focused, 734 discovered with exactly six allowlisted CUDA skips, all sibling suites and repository gates passed; no corpus, training, checkpoint write, CAD kernel, Stage 6, C8, or protected access | `verified-local` | [Record](ge1_autonomous_stop_validation_3355790.md) |
| GE1 exploratory Stage 6 authoritative CPU validation | `42d5c489c7236031ff18dfd13ca88af428ca7510` | `3355816` | Adroit stdout/stderr SHA-256 and scheduler evidence | Corpus-free exact-commit validation; 51/51 focused, 743/743 complete discovery with exactly six CUDA skips, all sibling suites and repository gates passed | `documented-external` | [Record](ge1_exploratory_stage6_validation_3355816.md) |
| GE1 exploratory Stage 6 hardware re-timing | `42d5c489c7236031ff18dfd13ca88af428ca7510` | `3355819` | Verified timing-v2 artifact, log hashes, and scheduler evidence on Adroit | Governed narrow train only; CPU and seeds 2026–2028 retained with no fallback; no development or outcome access | `documented-external` | [Record](ge1_exploratory_stage6_timing_3355819.md) |
| GE1 exploratory Stage 6 two-epoch lifecycle smoke | `42d5c489c7236031ff18dfd13ca88af428ca7510` | producer `3355822`; finalizer `3355823` | Verified producer, six-checkpoint bundle, and five-file final artifact on Adroit with recorded hashes | Authorized narrow train/development smoke only; epoch 2, exploratory, result-ineligible, forced inconclusive; epoch-200 command not submitted | `documented-external` | [Record](ge1_exploratory_stage6_smoke_3355822_3355823.md) |
