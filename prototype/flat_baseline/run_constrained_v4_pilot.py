"""Run the bounded V4 train-and-ordinary-IID-validation pilot."""
...
from .constrained_v4_pilot import run_constrained_v4_pilot
...
def main(argv=None):
    ...
    try:
        ...
        result = run_constrained_v4_pilot(
            ...
            json.dumps(
                {
                    ...
                    "error_code": getattr(
                        exc, "code", "unexpected_v4_pilot_error"
                    ),
