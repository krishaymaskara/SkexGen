"""Run the bounded V3 train-and-ordinary-IID-validation pilot."""
...
from .constrained_v3_pilot import run_constrained_v3_pilot
...
def main(argv=None):
    ...
    try:
        ...
        model_config = ConstrainedProfileV3Config()
        ...
        result = run_constrained_v3_pilot(
            ...
            json.dumps(
                {
                    ...
                    "error_code": getattr(
                        exc, "code", "unexpected_v3_pilot_error"
                    ),
