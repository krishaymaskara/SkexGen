"""Frozen configuration and partition boundary for the V4 IID pilot."""
...
PILOT_IDENTITY = (
    ...
    "NODE-CONDITIONED-CATEGORIES-v4-iid-pilot-v1"
)
...
class ConstrainedV4PilotError(RuntimeError):
...
class ConstrainedV4PilotConfig:
    ...
    output_dir: str = "constrained_v4_node_conditioned_iid_pilot"
