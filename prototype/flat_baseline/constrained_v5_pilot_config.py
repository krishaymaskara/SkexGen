"""Frozen configuration and partition boundary for the V5 IID pilot."""
...
PILOT_IDENTITY = (
    ...
    "NODE-CATEGORIES-PREFIX-GRAMMAR-v5-iid-pilot-v1"
)
...
class ConstrainedV5PilotError(RuntimeError):
...
class ConstrainedV5PilotConfig:
    ...
    output_dir: str = "constrained_v5_prefix_grammar_iid_pilot"
