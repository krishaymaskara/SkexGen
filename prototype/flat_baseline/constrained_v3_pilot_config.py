"""Frozen configuration and partition boundary for the V3 IID pilot."""
...
PILOT_IDENTITY = (
    "B0-FLAT-CONSTRAINED-PROFILE-CANONICAL-PLANE-v3-iid-pilot-v1"
)
...
class ConstrainedV3PilotError(RuntimeError):
...
class ConstrainedV3PilotConfig:
    ...
    output_dir: str = "constrained_v3_canonical_plane_iid_pilot"
