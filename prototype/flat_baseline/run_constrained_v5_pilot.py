"""Run the bounded V5 train-and-ordinary-IID-validation pilot."""
...
from .constrained_v5_pilot import run_constrained_v5_pilot
...
def main(argv=None):
    ...
    try:
        ...
        result = run_constrained_v5_pilot(
            ...
            json.dumps(
                {
                    ...
                    "error_code": getattr(
                        exc, "code", "unexpected_v5_pilot_error"
                    ),
